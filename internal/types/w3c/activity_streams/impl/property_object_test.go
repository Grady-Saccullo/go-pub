...
func TestDeserializePropertyObject_IRI(t *testing.T) {
	data, ldAliases, err := json_ld.ParseJson([]byte(testDeserializePropertyObject_IRIJson))
	if err != nil {
		t.Fatal(err)
	}
...
func TestDeserializePropertyObject_Array(t *testing.T) {
	data, ldAliases, err := json_ld.ParseJson([]byte(testDeserializePropertyObject_ArrayJson))
	if err != nil {
		t.Fatal(err)
	}
...
func TestDeserializePropertyObject_Nested(t *testing.T) {
	data, ldAliases, err := json_ld.ParseJson([]byte(testDeserializePropertyObject_NestedJson))
	if err != nil {
		t.Fatal(err)
	}
